...
//        int[] massivRandomNum = new int[52];

        int randomNum = ThreadLocalRandom.current().nextInt(0, 52);
        return cards[randomNum];
        //Element massivRandomNum[randomNum]!=1
//        if (massivRandomNum[randomNum] != 1){
//        massivRandomNum[randomNum] = massivRandomNum[randomNum] + 1;
//        return cards[randomNum];}
//        //Element massivRandomNum[randomNum]==1
//        else if (massivRandomNum[randomNum] == 1){
//            for(int i = 0, kolodaPust = 0; i < massivRandomNum.length; i++){
//                if (massivRandomNum[i] == 1){
//                    kolodaPust = kolodaPust + 1;
//                }
//                if (kolodaPust == massivRandomNum.length + 1){return getRandomCard();}
//            }
//            }
//
//        //massivRandomNum full 1
